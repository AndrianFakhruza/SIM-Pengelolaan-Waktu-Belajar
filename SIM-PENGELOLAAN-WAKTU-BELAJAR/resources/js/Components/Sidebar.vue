...
<template>
    <div class="w-60 flex flex-col border-r-2">
        ...
        <hr class="my-6 border-1 border-gray-400" />
        <div>
        ...
        <hr class="mt-10 border-1 border-gray-400" />

        <div class="flex items-center gap-4 ml-4 mt-6 text-gray-500">
            <h4>MY PROJECT</h4>

            <span v-html="addLogo" class="ml-10"></span>
        </div>
        <div class="flex flex-col items-center justify-center mt-16">
            <span v-html="lampuLogo" class="mb-4"></span>

            <div class="container text-center overflow-hidden w-40">
                <h3 class="text-xl font-semibold mb-2">Thoughts Time</h3>
